...
@author: sion jeon
'''
class avoid_ori_modeSM(Behavior):
	'''
	hihi
	'''
	...
	def __init__(self):
		super(avoid_ori_modeSM, self).__init__()
		self.name = 'avoid_ori_mode'
	...
	def create(self):
		...
		with _state_machine:
			# x:119 y:56
			OperatableStateMachine.add('AvoidTestMode',
										AvoidOriState(),
										transitions={'lane_control': 'AvoidTestMode', 'mission_control': 'failed'},
