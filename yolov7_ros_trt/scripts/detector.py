...
import sys
import os
from ma_ah_perception.yolov7_ros import YOLOV7_TRT_ROS
...
if __name__ == "__main__":
    ...
    categories = ["boom_barrier", "intersection", "left", "no_entry", "obstacle", "parking", "right", "stop", "traffic_light", "tunnel"]
