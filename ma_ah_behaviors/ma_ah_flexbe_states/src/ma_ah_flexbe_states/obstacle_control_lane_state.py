...
class ObstacleControlLaneState(EventState):
    ...
    def __init__(self):
        super(ObstacleControlLaneState, self).__init__(outcomes=['mission_control'], input_keys=['lane_info', 'scan_info'])
    ...
    def checkObstacle(self, start, end):
        scan = self.sub_scan.get_last_msg("/scan")
        scan_start = start
        scan_end = end
        threshold_distance = 0.28
    ...
    def execute(self, userdata):
        ...
        # lane control logic
        self.checkObstacle(userdata.scan_info[0], userdata.scan_info[1])
