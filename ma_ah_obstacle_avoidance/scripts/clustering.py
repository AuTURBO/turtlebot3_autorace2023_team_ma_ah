...
class LaserKMeansClustering:
    ...
    def process(self):
        ...
        if len(points) > 0:
            ...
            origin = np.array([0, 0])
            closest_center, closest_center_label = self.get_closet_point(origin, cluster_centers) # obstacle로 간주
            ...
            # RANSAC 적용
            ransac = RANSACRegressor(max_trials=100, min_samples=5, residual_threshold=0.05)
    ...
    # def obstacle_pass_check(self, points):
