...
class TrafficSign(EventState):
	...
	def __init__(self):
		...
		#super(TrafficSign, self).__init__(outcomes = ['lane_control', 'crossroad_sign', 'obstacle_detection', 'parking_detection', 'stop_bar_status', 'tunnel_info'])
		super(TrafficSign, self).__init__(outcomes = ['crossroad_sign', 'obstacle_detection', 'parking_detection', 'stop_bar_status', 'tunnel_info'])
	...
	def execute(self, userdata):
		...
		if self._sub.has_msg("/traffic_sign"):
			...
			if self._sign == "crossroad_sign":
				return 'crossroad_sign'
