...
class Lane_detector:
    def __init__(self, image_topic, cmd_vel_topic, lane_topic):
        ...
        self.center_line_publisher = rospy.Publisher(lane_topic, Float64, queue_size=10)
...
if __name__ == '__main__':
    ...
    lane_detector = Lane_detector(image_topic, cmd_vel_topic, lane_topic)
    rospy.spin()
