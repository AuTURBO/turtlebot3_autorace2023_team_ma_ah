...
class mission4parking_ver3SM(Behavior):
	...
	def create(self):
		...
		with _state_machine:
			# x:162 y:45
			OperatableStateMachine.add('find_parking_1',
										FindParkingState(),
										transitions={'left': 'find_parking_go_3', 'right': 'find_parking_1', 'proceed': 'find_parking_1'},
			...
			OperatableStateMachine.add('escape_left',
										MovingControlState(),
										transitions={'procced': 'escape_left', 'done': 'find_parking_go_2_2'},
			...
			# x:162 y:122
			OperatableStateMachine.add('find_parking_1_2',
										FindParkingState(),
										transitions={'left': 'find_parking_left_2', 'right': 'find_parking_1_2', 'proceed': 'find_parking_1_2'},
										autonomy={'left': Autonomy.Off, 'right': Autonomy.Off, 'proceed': Autonomy.Off})
			...
			OperatableStateMachine.add('find_parking_go_2_2',
										MovingControlState(),
										transitions={'procced': 'find_parking_go_2_2', 'done': 'escape_lane_control_2'},
										autonomy={'procced': Autonomy.Off, 'done': Autonomy.Off},
										remapping={'moving_info': 'go', 'target_distance': 'target_distance', 'target_theta': 'target_theta'})
			...
			OperatableStateMachine.add('find_parking_go_3',
										MovingControlState(),
										transitions={'procced': 'find_parking_go_3', 'done': 'find_parking_1_2'},
										autonomy={'procced': Autonomy.Off, 'done': Autonomy.Off},
										remapping={'moving_info': 'go', 'target_distance': 'target_distance', 'target_theta': 'target_theta'})

			# x:450 y:147
			OperatableStateMachine.add('find_parking_go_3_2',
										MovingControlState(),
										transitions={'procced': 'find_parking_go_3_2', 'done': 'find_parking'},
										autonomy={'procced': Autonomy.Off, 'done': Autonomy.Off},
										remapping={'moving_info': 'go', 'target_distance': 'target_distance', 'target_theta': 'target_theta'})
			...
			# x:293 y:213
			OperatableStateMachine.add('find_parking_left_2',
										MovingControlState(),
										transitions={'procced': 'find_parking_left_2', 'done': 'find_parking_go_3_2'},
										autonomy={'procced': Autonomy.Off, 'done': Autonomy.Off},
										remapping={'moving_info': 'left', 'target_distance': 'target_distance', 'target_theta': 'target_theta'})
