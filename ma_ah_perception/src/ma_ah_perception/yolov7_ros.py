...
class YOLOV7_TRT_ROS:
    def __init__(self, conf_thresh, img_size, visualize, input_img_topic, pub_topic, output_img_topic, categories):
        ...
        self.model = YoloTRT(library="/home/nvidia/catkin_ws/src/turtlebot3_autorace2023_team_ma_ah/yolov7_ros_trt/JetsonYoloV7-TensorRT/yolov7/build/libmyplugins.so", engine="/home/nvidia/catkin_ws/src/turtlebot3_autorace2023_team_ma_ah/yolov7_ros_trt/JetsonYoloV7-TensorRT/yolov7/build/yolov7-tiny.engine", conf=self.conf_thresh, categories=self.categories, yolo_ver="v7")
