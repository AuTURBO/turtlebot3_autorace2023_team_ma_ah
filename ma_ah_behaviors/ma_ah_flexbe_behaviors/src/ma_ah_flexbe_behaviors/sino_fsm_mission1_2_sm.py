...
@author: sion
'''
class sino_fsm_Mission1_2SM(Behavior):
	'''
	hello
	'''
	...
	def __init__(self):
		super(sino_fsm_Mission1_2SM, self).__init__()
		self.name = 'sino_fsm_Mission1_2'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Traffic light',
										TrafficLightState(),
										transitions={'proceed': 'Traffic light', 'done': 'lane control'},
